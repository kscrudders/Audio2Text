...
<!-- PROJECT LOGO --> <br /> <div align="center">   <a href="https://github.com/kscrudders/Audio2Text"> <img src="images/Audio2Text_projectlogo.png" alt="Logo" width="212" height="325"> </a> <h3 align="center">Audio2Text Transcription (Audio2Text)</h3> <p align="center"> A Python-based UI for audio-to-text transcription using Nvidia's Canary and Parakeet models <br /> <a href="https://github.com/kscrudders/Audio2Text"><strong>Explore the docs »</strong></a> <br /> <br /> <a href="https://github.com/kscrudders/Audio2Text/issues">Report Bug</a> · <a href="https://github.com/kscrudders/Audio2Text/issues">Request Feature</a> </p> </div> <!-- TABLE OF CONTENTS --> <details> <summary>Table of Contents</summary> <ol> <li><a href="#about-the-project">About The Project</a></li> <li><a href="#built-with">Built With</a></li> <li><a href="#getting-started">Getting Started</a> <ul> <li><a href="#prerequisites">Prerequisites</a></li> <li><a href="#installation">Installation</a></li> </ul> </li> <li><a href="#usage">Usage</a></li> <li><a href="#roadmap">Roadmap</a></li> <li><a href="#contributing">Contributing</a></li> <li><a href="#license">License</a></li> <li><a href="#contact">Contact</a></li> <li><a href="#acknowledgments">Acknowledgments</a></li> </ol> </details> <!-- ABOUT THE PROJECT -->
About The Project: </p>
